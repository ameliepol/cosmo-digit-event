...
workshop8 = Workshop.find_by(name: "Acteurs du secteur de la jeunesse / Focus sur les opportunités Erasmus + 2021-2027")
workshop8.update(name: "Acteurs du secteur de la jeunesse et du sport / Focus sur les opportunités Erasmus + 2021-2027", description: "Cette session s’adresse aux participants qui souhaitent approfondir les nouveautés des projets de mobilités ou de coopération du secteur de la jeunesse et du sport")
...
workshop13.update(name: "Secteur jeunesse et sport", description: "Vos questions, nos réponses")
